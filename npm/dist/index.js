...
import initWasm, { parse_and_build_graph, render_graph, supported_languages as wasm_supported_languages } from '../codeviz-wasm/pkg/codeviz_wasm.js';
...
export function parse_to_json(source, language) {
...
export function parse(source, language, diagram_kind) {
