...
- `[x]` **Batch 10 (Phase 10)**: Distribution (GitHub Action + npm WASM) (Tasks 23, 24)

## Phase 11-12: Web UI & CFG
- `[x]` **Batch 11 (Phase 11)**: Web UI Scaffolding & Graph (Tasks 28, 29)
- `[x]` **Batch 12 (Phase 12)**: Control Flow Graph & UI Side Panel (Tasks 30-32)
...
### `[x]` Batch 20 — MVP v1 Core Tools
- `[x]` **T47** `[OSS]` VS Code Extension — sidebar graph panel, status bar, auto-refresh on save
...
- `[ ]` **T63**: **Playground AST & Drag Improvements**. Extract object-oriented AST edges (inheritance, methods) and refactor React Flow canvas to use draggable state. **[Assigned to Jules]**
